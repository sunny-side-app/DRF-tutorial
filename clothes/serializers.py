...
from .models import Clothes, Product, Order, Rating, User, Favorite, WishList, CartItem, OrderItem, Payment, Shipping, Size, Target, ClothesType, Brand 
...
class ProductSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        fields = ('id', 'title', 'description', 'price', 'stock_quantity', 'release_date', 'size', 'target', 'clothes_type', 'brand')
...
class ShippingSerializer(serializers.ModelSerializer):
    class Meta:
        model = Shipping
        fields = ('order', 'shipping_tracking_number', 'shipping_date', 'shipping_address', 'address_code')
