...
urlpatterns = [
    ...
    path('api/clothestypes/', views.ClothesTypeListCreateView.as_view(), name='clothestype-list-create'),
    path('api/clothestypes/<int:pk>/', views.ClothesTypeDetailView.as_view(), name='clothestype-detail'),
